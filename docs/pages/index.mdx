...
<Cards>
  <Card title="Declarative DSL" href="/language/overview">
    Define memory schemas, handlers, queries, and update rules in `.mnm` files. No boilerplate.
  </Card>
  <Card title="Multi-Backend" href="/language/config">
  ...
  <Card title="Temporal Updates" href="/language/updates">
    Confidence decay, conflict resolution, periodic maintenance. Define how memory evolves over time.
  </Card>
  <Card title="Hybrid Queries" href="/language/queries">
